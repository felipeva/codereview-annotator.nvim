...
| `codereview/frame_child.lua` | Spawned once by `frame_spec`, for one painted cell: the pane's last column on the blank **pad** row that closes a file, inside a muted pane — deliberately not a spec. |
